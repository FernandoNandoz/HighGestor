...
namespace High_Gestor.Forms.Financeiro.Parametros.CentroCustos
{
    public partial class FormCentroCustos : Form
    {
        ...
        public FormCentroCustos()
        {
            ...
            SendMessage(textBoxPesquisar.Handle, EM_SETCUEBANNER, 0, "Pesquisar Custo");
        ...
        private void verificarQuantidadeCusto()
        {
            ...
            string Custo = ("SELECT COUNT(*) FROM CentroCusto WHERE status = 'ATIVO'");
        ...
        private void dataCusto()
        {
            ...
            string Produtos = ("SELECT idCentroCusto, codigoCusto, descricao, status FROM CentroCusto WHERE status = 'ATIVO' ORDER BY descricao");
        ...
        private void buttonAdicionarCusto_Click(object sender, EventArgs e)
        {
        ...
        {
            //Retorna os dados da tabela Produtos para o DataGridView
            string Categoria = ("SELECT idCentroCusto, codigoCusto, descricao, status FROM CentroCusto WHERE status = 'ATIVO' AND descricao LIKE (@descricao + '%') ORDER BY descricao");
